...
const columns = [
  {
    ...
    links: [
      ...
      { label: "Homologación y riesgo", href: "#homologacion" },
      { label: "Control e integración", href: "#control" },
  ...
  },
  {
    title: "Empresa",
    links: [
      { label: "Por qué Procurex", href: "#por-que" },
    ...
    <footer className="border-t border-border bg-muted/30 pt-16 text-muted-foreground">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-muted-foreground">
              Compras corporativas con proveedores homologados por nuestro
              equipo de compliance, de la solicitud al pago.
            </p>
            <div className="mt-5 flex gap-3">
              <a
                href="mailto:hola@procureos.com"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-background transition-colors hover:bg-accent"
                aria-label="Correo"
              >
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-border py-6 text-xs text-muted-foreground sm:flex-row">
          <span>
            © {new Date().getFullYear()} Procurex. Todos los derechos
            reservados.
          </span>
          <div className="flex items-center gap-4">
            ...
            <span className="hidden sm:inline">
              Hecho para equipos de compras en Latinoamérica.
            </span>
          </div>
        </div>
      </div>
