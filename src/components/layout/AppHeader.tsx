...
const destinationsByPortal: Record<Portal, { label: string; to: string; roles?: Role[] }[]> = {
  cliente: [
    ...
    { label: "Procesos de compra", to: "procesos", roles: ["comprador", "admin_cliente", "aprobador_cfo"] },
    { label: "Contratos / POs", to: "contratos" },
    { label: "Entregas", to: "contratos?vista=entregas", roles: ["comprador", "admin_cliente"] },
    ...
    { label: "Plantillas y documentos", to: "plantillas", roles: ["admin_cliente"] },
    { label: "Integración ERP", to: "integraciones", roles: ["admin_cliente", "aprobador_cfo"] },
  ],
  proveedor: [
    { label: "Dashboard", to: "dashboard" },
    { label: "Homologación", to: "homologacion" },
    { label: "Procesos nuevos", to: "procesos" },
    { label: "Procesos en los que participo", to: "procesos?vista=participando" },
    { label: "Procesos terminados", to: "procesos?vista=terminados" },
    { label: "Mi desempeño", to: "desempeno" },
    { label: "Mis Contratos", to: "contratos" },
    { label: "Pagos", to: "pagos" },
    { label: "Perfil y vitrina", to: "perfil" },
    { label: "Mi vitrina", to: "perfil?vista=vitrina" },
  ],
  interno: [
