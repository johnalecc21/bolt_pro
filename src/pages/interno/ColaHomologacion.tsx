...
const CATEGORIA_SCORE_LABEL: Record<keyof ScoreDesglose, string> = {
          ...
          {(Object.keys(scoreDesglose) as (keyof ScoreDesglose)[]).map((k) => (
            <div key={k} className="rounded-md bg-muted/40 p-2">
              <div className="flex items-center justify-between text-xs">
                <span className="text-muted-foreground">{CATEGORIA_SCORE_LABEL[k]} · {Math.round(PESOS_SCORE[k] * 100)}%</span>
